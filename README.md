...
## ニュース
newsフォルダ以下のMDファイルからニュース毎の記事を作成してください。
トップページについては、日付とニュースタイトルの一覧をかっこよく表示してください。日付の降順としてください。
...
１）個人会員　年会費 5,000円 
２）法人会員　年会費 10,000円 
年会費は、後援会会計年度として月割はしない。 
納入された会費はいかなる場合も返還は行わない。  
...
## 日英対応
日本語サイトと英語サイトをボタン一つで切り替えれるようにしてください。
英語サイトでは、英語に翻訳済みのコンテンツを表示してください。
日本語サイトでのボタンはEnglishとしてください。
英語サイトでのボタンは日本語としてください。

docsフォルダ以下のファイルも英語に翻訳したPDFを作成し、ファイル名を英語化し、英語サイトから適切にリンクを張ってください。
